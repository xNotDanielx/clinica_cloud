    ...
    <div className="min-h-screen bg-[#050816] text-white overflow-x-hidden">
      <header className="fixed top-0 left-0 right-0 z-50 border-b border-white/10 bg-black/35 backdrop-blur-2xl">
        <div className="mx-auto flex max-w-7xl items-center justify-between px-4 py-4 sm:px-6 lg:px-8">
          ...
          <nav className="hidden md:flex flex-1 justify-center items-center gap-10 text-base md:text-lg font-bold">
            <a
              className="nav-link-ghost text-base md:text-lg uppercase tracking-[0.16em]"
              href="#inicio"
            >
              INICIO
            </a>
      ...
      <main className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 pt-28">
        <section id="inicio" className="py-20 md:py-28 scroll-mt-28">
          <div className="grid items-start gap-6 lg:grid-cols-2">
            <div className="rounded-4xl border border-white/10 bg-white/5 p-8 md:p-10 backdrop-blur-xl">
              ...
              <p className="mt-6 text-lg md:text-xl leading-8 text-slate-300 max-w-2xl">
                Un espacio especializado en procedimientos corporales, atención
                personalizada y una experiencia moderna. El doctor Miguel
                Mendoza brinda valoración individual, enfoque estético y
                seguimiento cercano para cada paciente.
              </p>
            ...
            <div className="relative">
              <div className="absolute -inset-6 rounded-[2.5rem] bg-linear-to-tr from-violet-600/20 via-cyan-500/15 to-transparent blur-2xl" />
              <div className="relative overflow-hidden rounded-[2.5rem] border border-white/10 bg-white/5 p-5 shadow-2xl backdrop-blur-xl">
                <div className="aspect-4/5 w-full rounded-4xl bg-black flex items-center justify-center text-lg text-white/45">
                  Foto del doctor
                </div>
              </div>
            </div>
          ...
          <div className="mt-8 grid gap-4 md:grid-cols-2 xl:grid-cols-4">
            {[
              [
                "Experiencia",
                "Atención profesional con enfoque en resultados naturales.",
              ],
              [
                "Seguridad",
                "Valoración previa y acompañamiento médico en cada proceso.",
              ],
              [
                "Acompañamiento",
                "Seguimiento cercano antes y después de la cirugía.",
              ],
              [
                "Confianza",
                "Información clara para ayudarte a tomar la mejor decisión.",
              ],
            ].map(([title, text]) => (
              <article
                key={title}
              ...
              >
                ...
                <p className="card-text text-center max-w-88">{text}</p>
              </article>
            ))}
          </div>
        </section>
        ...
        <section id="procedimientos" className="py-20 md:py-28 scroll-mt-28">
          <div className="mb-10 text-center max-w-4xl mx-auto">
            ...
            <p className="mt-4 text-lg md:text-xl text-slate-300">
              Selecciona mínimo 1 y máximo 2 procedimientos.
            </p>
          </div>
            ...
            {(procedureList as any[]).map((p) => {
              ...
              const image =
                rawImage && rawImage.startsWith("http")
                  ? rawImage
                  : rawImage
                    ? `${API_URL}/${String(rawImage).replace(/^\/+/, "")}`
                    : "";
              ...
              return (
                ...
                >
                  <div className="procedure-hover-front h-full flex flex-col items-center justify-center text-center">
                    ...
                    <p className="mt-6 text-lg md:text-xl text-slate-200 leading-8 max-w-120 mx-auto">
                      {info}
                    </p>
                  </div>
          ...
          <div className="mt-10 rounded-3xl border border-white/10 bg-white/5 p-6 md:p-8 backdrop-blur-xl flex flex-col md:flex-row items-center justify-between gap-6 text-center md:text-left">
            <div className="mx-auto md:mx-0 max-w-3xl">
              ...
              <p className="mt-3 text-base md:text-lg text-slate-300 max-w-2xl mx-auto md:mx-0">
                Los valores se confirman directamente con el doctor durante la
                consulta, ya que pueden variar según promociones, valoración
                médica y características del procedimiento.
              </p>
            </div>
            <button
              type="button"
        ...
        <section id="galeria" className="py-20 md:py-28 scroll-mt-28">
          ...
          <div className="grid gap-6 md:grid-cols-2 xl:grid-cols-3">
            {galleryPairs.map((pair, idx) => (
              <div
                key={idx}
                className="grid gap-4 rounded-4xl border border-white/10 bg-white/5 p-4 backdrop-blur-xl"
              >
          ...
          <div className="grid gap-6 lg:grid-cols-2 items-stretch">
            <div className="contact-card">
              ...
              <div className="mt-8 space-y-6 text-slate-300 leading-8 text-lg md:text-xl">
                ...
                <p>
                  ...
                  Hernando De Aguirre 128, Consultorio 805, Edificio Copiapó,
                  Providencia. Metro Tobalaba
                </p>
                <p>
                  <span className="font-semibold text-white">Correo:</span>{" "}
                  contacto@clinicarenacer.com
                </p>
                <p>
            ...
            <div className="map-card">
              <iframe
                ...
                className="h-140 w-full rounded-[1.3rem] border-0 grayscale-[0.1]"
                loading="lazy"
      ...
      <footer className="border-t border-white/10 bg-black/20">
        <div className="mx-auto flex max-w-7xl flex-col items-center justify-between gap-3 px-4 py-8 text-sm text-slate-400 sm:flex-row sm:px-6 lg:px-8">
          <p>Cl?nica Renacer ? Plataforma de gesti?n y agendamiento</p>
      ...
      {isModalOpen && (
        ...
        >
          <div
            ...
            className="relative w-full max-w-2xl overflow-hidden rounded-4xl border border-white/10 bg-[#0b1220] shadow-2xl shadow-black/40"
            ...
            >
              <div className="grid gap-4 md:grid-cols-2">
                ...
                <div>
                  ...
                  {errors.sexo && (
                    <p className="mt-2 text-sm text-rose-300">{errors.sexo}</p>
                  )}
                </div>
                ...
                <div className="md:col-span-2">
                  ...
                  />
                  {errors.fecha && (
                    <p className="mt-2 text-sm text-rose-300">{errors.fecha}</p>
                  )}
                </div>
                ...
                <div>
                  ...
                  {errors.hora && (
                    <p className="mt-2 text-sm text-rose-300">{errors.hora}</p>
                  )}
                </div>
                  ...
                  <div className="grid gap-3 md:grid-cols-2">
                    {procedureList.map((p) => {
                      ...
                      return (
                        ...
                        >
                          <div className="flex h-full min-h-18 items-center justify-center text-center text-[1rem] font-medium leading-snug tracking-normal normal-case">
                            {name}
                          </div>
                        </button>
                      );
...
function Separator({ glow = "cyan" }: { glow?: "cyan" | "violet" }) {
  ...
  return (
    <div className="relative my-8 h-28 w-full overflow-visible">
      <div className={`absolute inset-x-0 top-1/2 h-px -translate-y-1/2 bg-linear-to-r ${glowClass}`} />
      <div className={`absolute inset-x-[4%] top-1/2 h-20 -translate-y-1/2 bg-linear-to-r ${glowClass} blur-3xl opacity-70`} />
